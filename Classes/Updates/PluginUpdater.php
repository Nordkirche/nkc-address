...
class PluginUpdater implements UpgradeWizardInterface
{
    private const MIGRATION_SETTINGS = [
        [
            'switchableControllerActions' => 'Institution->list;Institution->search',
            'targetListType' => 'nkcaddress_institutionlist',
        ],
        [
            'switchableControllerActions' => 'Institution->searchForm',
            'targetListType' => 'nkcaddress_institutionsearchform',
        ],
        [
            'switchableControllerActions' => 'Institution->show',
            'targetListType' => 'nkcaddress_institution',
        ],
        [
            'switchableControllerActions' => 'Institution->redirect',
            'targetListType' => 'nkcaddress_institutionredirect',
        ],
        [
            'switchableControllerActions' => 'Person->list;Person->search',
            'targetListType' => 'nkcaddress_personlist',
        ],
        [
            'switchableControllerActions' => 'Person->searchForm',
            'targetListType' => 'nkcaddress_personsearchform',
        ],
        [
            'switchableControllerActions' => 'Person->show',
            'targetListType' => 'nkcaddress_person',
        ],
        [
            'switchableControllerActions' => 'Person->redirect',
            'targetListType' => 'nkcaddress_personredirect',
        ],
        [
            'switchableControllerActions' => 'Map->show;Map->data;Map->paginatedData',
            'targetListType' => 'nkcaddress_map',
        ],
        [
    ...
    {
        return 'txNkcAddressPluginUpdater';
    }

    public function getTitle(): string
    {
        return 'EXT:nkc_adress: Migrate plugins';
    }
